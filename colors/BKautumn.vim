...
" Last Change: 2016/7/5 Mon 16:41.
"     version: 1.0
...
let colors_name = "BKautumn"

hi Normal       guifg=#f0f0f0 guibg=#fff4e8
...
hi Visual       gui=NONE guifg=#ffffff guibg=#ffc0a0
" hi VisualNOS  gui=NONE guifg=#604040 guibg=#e8dddd

" Syntax group
hi Comment      gui=NONE guifg=#ff5050 guibg=NONE
hi Constant     gui=NONE cterm=bold ctermfg=1 guifg=#00884c guibg=NONE
