...
syn region cupCodeInclude matchgroup=cupCodeIncludeMark start="^parser code {:" end=":}" contains=@pythonTop contained
syn region cupCodeInclude matchgroup=cupCodeIncludeMark start="^action code {:" end=":}" contains=@pythonTop contained
syn region cupCodeInclude matchgroup=cupCodeIncludeMark start="^init code {:" end=":}" contains=@pythonTop contained
...
syn region cupActionCode matchgroup=Delimiter start="{:" end=":}" contained contains=@pythonTop,cupPythonBraces

" keep braces in actions balanced
syn region cupPythonBraces start="{" end="}" contained contains=@pythonTop,cupPythonBraces
